...
public class UserInterface{
	public static void main(String args[])throws Exception{
		...
		try {//읽어오기
			//fIn에 information.data파일 저장
			//FileInputStream fIn = new FileInputStream("information.data");
			//in에 fIn저장
			in = new DataInputStream(new FileInputStream("information.data"));
							...
							try {
								...
								case 7://저장
									...
									try {
										...
										//out에 fOut저장
										out = new DataOutputStream(new FileOutputStream("information.data"));
